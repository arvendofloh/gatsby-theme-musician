...
export default () => {
  const { site, bannerImg, socialImg, heroImg, logoImg } = useStaticQuery(siteQuery)
  ...
  site.siteMetadata.heroImg = heroImg
...
const siteQuery = graphql`
  query SiteQuery {
    ...
    socialImg: imageSharp(fluid: { src: { regex: "/artist-social./" } }) {
